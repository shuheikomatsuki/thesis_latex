...
発話内容の正確性，自然性，および話者類似性の品質低下の有無とその要因を，
...
予測されたトークンおよび音声から抽出される話者埋め込みを条件として
...
対象モジュールにLoRA（Low-Rank Adaptation）などのパラメータ効率的な
追加学習，またはadapterを導入する．その上で，学習に用いるデータセットを
決定する．
